...
export async function GetStoreTotalItemsProfit(id) {
  const response = await fetch(
    `${SOURCE}/api/Sale/GetStoreItemTotalProfit/${id}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export async function GetStoreTotalItemIncom(id) {
  const response = await fetch(
    `${SOURCE}/api/Sale/GetStoreItemTotalIncome/${id}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export async function GetStoreItemAverageProfit(id) {
  const response = await fetch(
    `${SOURCE}/api/Sale/GetStoreItemAverageProfit/${id}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export async function GetStoreItemAverageIncome(id) {
  const response = await fetch(
    `${SOURCE}/api/Sale/GetStoreItemAverageIncome/${id}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
